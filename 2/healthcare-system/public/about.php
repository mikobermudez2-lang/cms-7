        ...
        <div class="row g-4 mt-4">
            <div class="col-md-4">
                <div class="text-center p-4 bg-light rounded">
                    <h2 class="text-primary fw-bold"><?= e((string) max($publishedStories, 1)); ?>+</h2>
            ...
            <div class="col-md-4">
                <div class="text-center p-4 bg-light rounded">
                    ...
                    <p class="text-muted mb-0">Years Serving Communities</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-center p-4 bg-light rounded">
                    <h2 class="text-primary fw-bold">40+</h2>
                    <p class="text-muted mb-0">Community Programs</p>
                </div>
            </div>
        </div>
    </div>
