        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="siteNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $currentPage === 'doctors' ? 'active' : ''; ?>" href="<?= url('/public/doctors.php'); ?>">Doctors</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $currentPage === 'contact' ? 'active' : ''; ?>" href="<?= url('/public/contact.php'); ?>">Contact</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-primary <?= $currentPage === 'appointment' ? 'active' : ''; ?>" href="<?= url('/public/appointment.php'); ?>">Book Appointment</a>
                    </li>
                </ul>
            </div>
        </div>
